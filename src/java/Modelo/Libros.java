...
@NamedQueries({
    ...
    @NamedQuery(name = "Libros.findByComentario", query = "SELECT l FROM Libros l WHERE l.comentario = :comentario")})
public class Libros implements Serializable {
    ...
    public Libros(Integer id, String titulo, String autor, String comentario) {
        this.id = id;
        this.titulo = titulo;
        this.autor = autor;
